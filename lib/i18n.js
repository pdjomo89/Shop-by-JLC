      ...
      tiers: [
        {
          name: "Starter",
          price: "9.99 €",
          description: "For solo shop owners who want clarity, fast.",
          features: [
            "1 business unit",
            "Core profitability KPIs",
            "Weekly profit verdict",
            "Email support",
          ],
        ...
        },
        {
          name: "Pro",
          price: "19.99 €",
          description: "For growing shops that need more depth.",
          features: [
            "Up to 3 business units",
            "Advanced KPIs & trends",
            "Cost & margin breakdowns",
        ...
        },
        {
          name: "Business / Team",
          price: "39.99 €",
          description: "For hybrid and production businesses with a team.",
          features: [
            "Up to 10 users",
        ...
        },
        {
          name: "Enterprise",
          price: "from 79.99 €",
          description: "For multi-shop operators and franchises.",
          features: [
      ...
      tiers: [
        {
          name: "Starter",
          price: "9,99 €",
          description: "Pour les commerçants solo qui veulent de la clarté, vite.",
          features: [
            "1 unité d'activité",
            "KPI de rentabilité essentiels",
            "Verdict de profit hebdomadaire",
            "Support par e-mail",
          ],
        ...
        },
        {
          ...
          price: "39,99 €",
          description: "Pour les activités hybrides et de production avec une équipe.",
          features: [
            "Jusqu'à 10 utilisateurs",
            "KPI production & stocks",
        ...
        },
        {
          ...
          description: "Pour les multi-boutiques et les franchises.",
          features: [
            "Utilisateurs et unités illimités",
            "KPI et tableaux de bord sur mesure",
            "API & intégrations",
      ...
      tiers: [
        {
          name: "Starter",
          price: "9,99 €",
          description: "Für Einzelunternehmer, die schnell Klarheit wollen.",
          features: [
            "1 Geschäftseinheit",
            "Kern-Profitabilitäts-KPIs",
            "Wöchentliches Profit-Verdikt",
            "E-Mail-Support",
          ],
        ...
        },
        {
          name: "Pro",
          price: "19,99 €",
          description: "Für wachsende Betriebe, die mehr Tiefe wollen.",
          features: [
            "Bis zu 3 Geschäftseinheiten",
            "Erweiterte KPIs & Trends",
            "Kosten- & Margen-Analysen",
            "E-Mail-Support mit Priorität",
          ],
          cta: "Pro wählen",
        },
        {
          name: "Business / Team",
          price: "39,99 €",
          description: "Für Hybrid- und Produktionsbetriebe mit Team.",
          features: [
            "Bis zu 10 Nutzer",
            "Produktions- & Inventar-KPIs",
            "Team-Rollen & Rechte",
            "Chat-Support",
          ],
          cta: "Business wählen",
        },
        {
          name: "Enterprise",
          price: "ab 79,99 €",
          description: "Für Multi-Standort-Betriebe und Franchises.",
          features: [
            "Unbegrenzt Nutzer & Einheiten",
            "Individuelle KPIs & Dashboards",
            "API & Integrationen",
